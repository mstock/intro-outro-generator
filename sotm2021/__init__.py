...
# URL to Schedule-XML
scheduleUrl = 'https://sotm.osmz.ru/2021.xml'
sessionsUrl = 'https://2021.stateofthemap.org/sessions/{0}/'
...
def tasks(queue, args, idlist, skiplist):
	...
	for event in events(scheduleUrl):
		if event['room'] not in ('Track 1 - Talks', 'Track 2 - Panels and Workshops'):
